...
import { FaAsterisk, FaCog, FaUpload } from "react-icons/fa";
...
const TextInputField = ({ id }: { id: number }) => {
  ...
  }, [expand, id, isInput, manager, tbAnimate, tbRef]);
  ...
  }, [expand, id, manager, required, tbAnimate2, tbRef2]);
  ...
  return (
    <motion.div
      className="w-full flex flex-col bg-neutral-600 rounded-3xl p-2 md:p-3 work gap-2 text-white relative md:text-base text-sm"
